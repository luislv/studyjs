/**
 @ Name : Loislv Javascript Library
 @ Author :Loislv
 @ Date : 2018-03-03
 @ Email : 1472116@qq.com
 @ Version : 1.0
 @ Update : 
 功能：
 1:  $ID选择
        ...
        geterateCompareTRs : function (iCol, sDataType) { //比较函数，用于sort排序用
            return function compareTRs(oTR1, oTR2) {
                ...
                if (oTR1.cells[iCol].getAttribute("value")) { //用于高级排序，比如图片，添加一个额外的属性来排序
                    vValue1 = JK.convert(oTR1.cells[iCol].getAttribute("value"), sDataType);
                    vValue2 = JK.convert(oTR2.cells[iCol].getAttribute("value"), sDataType);
                } else {
                    vValue1 = JK.convert(oTR1.cells[iCol].firstChild.nodeValue, sDataType);
                    vValue2 = JK.convert(oTR2.cells[iCol].firstChild.nodeValue, sDataType);
                }
                if (vValue1 < vValue2) {
                    return -1;
